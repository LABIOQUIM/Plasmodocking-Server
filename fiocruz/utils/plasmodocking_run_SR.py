...
def preparar_dados_receptor(macromolecula, ligantes_pdbqt, diretorio_dlgs,diretorio_ligantes_pdbqt,diretorio_macromoleculas,username,nome):
    ...
    for ligante_pdbqt in ligantes_pdbqt:
        ...
        dir_path = os.path.join(settings.MEDIA_ROOT, "macromoleculas","semRedocking", f"{macromolecula.rec}")
        ...
        bcaminho = os.path.join(settings.MEDIA_ROOT, "macromoleculas","semRedocking", f"{macromolecula.rec}", "best.pdbqt")
